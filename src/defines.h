...
#define MAX_VCHANNELS \
    (uint)X32_VCHANNELTYPE::NORMAL + \
    (uint)X32_VCHANNELTYPE::AUX + \
    (uint)X32_VCHANNELTYPE::FXRET + \
    (uint)X32_VCHANNELTYPE::BUS + \
    (uint)X32_VCHANNELTYPE::MATRIX + \
    (uint)X32_VCHANNELTYPE::DCA + \
    (uint)X32_VCHANNELTYPE::MAIN + \
    (uint)X32_VCHANNELTYPE::MAINSUB + \
    (uint)X32_VCHANNELTYPE::SPECIAL
